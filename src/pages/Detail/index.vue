        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a href="javascript:" @click="addCars()">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
import Zoom from './Zoom/Zoom'
  ...
  methods: {
    ...
    addCars() {
      //发请求通知服务器添加到数据库，如果成功就路由跳转，如果失败就提示用户，不进行路由跳转，所以要先进行添加是否成功的判断，才能进行路由的跳转
      // this.$store.dispatch('getAddCarsInfo', { skuId: this.$route.params.skuid, skuNum: this.skuNum })
      this.$router.push(`/addcartsuccess?skuid=${this.$route.params.skuid}`)
